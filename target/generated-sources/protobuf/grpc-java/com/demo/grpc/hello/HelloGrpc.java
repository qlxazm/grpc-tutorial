...
public final class HelloGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.grpc.hello.HelloRequest,
      com.demo.grpc.hello.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.demo.grpc.hello.HelloRequest.class,
      responseType = com.demo.grpc.hello.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.demo.grpc.hello.HelloRequest,
      com.demo.grpc.hello.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.demo.grpc.hello.HelloRequest, com.demo.grpc.hello.HelloResponse> getSayHelloMethod;
      ...
      synchronized (HelloGrpc.class) {
        if ((getSayHelloMethod = HelloGrpc.getSayHelloMethod) == null) {
          HelloGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.demo.grpc.hello.HelloRequest, com.demo.grpc.hello.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.hello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.hello.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.demo.grpc.hello.HelloRequest request,
        io.grpc.stub.StreamObserver<com.demo.grpc.hello.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.demo.grpc.hello.HelloRequest,
                com.demo.grpc.hello.HelloResponse>(
  ...
  public static final class HelloBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloBlockingStub> {
    ...
    /**
     */
    public com.demo.grpc.hello.HelloResponse sayHello(com.demo.grpc.hello.HelloRequest request) {
  ...
  public static final class HelloFutureStub extends io.grpc.stub.AbstractFutureStub<HelloFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.demo.grpc.hello.HelloResponse> sayHello(
        com.demo.grpc.hello.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.demo.grpc.hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.demo.grpc.hello.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.demo.grpc.hello.HelloProto.getDescriptor();
    }
